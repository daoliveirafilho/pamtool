...
O phpPgAdmin &eacute; uma ferramenta de gerenciamento de c&oacute;digo aberto para Postgres, o pacote deve ser descompactado no diret&oacute;rio referente ao alias configurado em nginx.conf.
